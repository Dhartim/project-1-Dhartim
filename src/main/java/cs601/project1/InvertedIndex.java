...
{
	private HashMap<String, List<WrapperFrequency>> invertedIndex = new HashMap<>();
	...
	public static List<WrapperFrequency> sort(List<WrapperFrequency> unsortedMap)
	{
		Collections.sort(unsortedMap, new Comparator<WrapperFrequency>(){
			public int compare(WrapperFrequency object1, //check value of word's frequency with another word's frequency
